...
public class HumanResourceInternalView extends JInternalFrame implements ActionListener{
	...
	public HumanResourceInternalView() {
		...
		tabbedPane.addTab("Delete Employee", null, deleteTab, null);
		...
		btn_delete = new JButton("Delete Employee");
		...
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Employee Username");
		lblNewLabel_1_1_1_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1_1_1_1.setBounds(162, 124, 133, 16);
		resetTab.add(lblNewLabel_1_1_1_1);
		...
		if(e.getSource() == btn_delete) {
			...
			if(confirm==0) {				
				if (validateDelete(employeeID)) {
					if(EmployeeHandler.getInstance().deleteData(employeeID)) {
